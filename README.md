...
В папке `src` мы уже подготовили для тебя шаблон тестовой стратегии (файл `exercise1.doc`). Осталось только лишь его заполнить! Внимательно составляй стратегию, так как она напрямую связана со следующим заданием. 
